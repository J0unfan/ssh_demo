  ...
  <html:form action="user">
  	...
  	<span style="font-weight:bold;">查询条件</span>
		...
		<logic:iterate id="item" name="userForm" property="pageResult.list"
			type="org.jb.app.demo.entity.SysUser"> 
			<tr>
				...
				<td class="data_cell">
					...
					<logic:notEqual name="item" property="usrFlag" value="0">
						<button class="op_button" onclick="doDel(${item.usrId })" style="width:40px;">删除</button>
						<button class="op_button" onclick="window.location.href='?o=toEdit&id=${item.usrId }'" style="width:40px;">编辑</button>
						<button class="op_button" onclick="window.location.href='?o=toAssignRole&id=${item.usrId }'" style="width:60px;">分配角色</button>
					</logic:notEqual>
					<logic:equal name="item" property="usrFlag" value="0">
						<button class="op_button" onclick="doDel(${item.usrId })" disabled="true" style="width:40px;">删除</button>
						<button class="op_button" onclick="window.location.href='?o=toEdit&id=${item.usrId }'" disabled="true" style="width:40px;">编辑</button>
						<button class="op_button" onclick="window.location.href='?o=toAssignRole&id=${item.usrId }'" disabled="true" style="width:60px;">分配角色</button>
					</logic:equal>
				</td>
			</tr>
		</logic:iterate>
